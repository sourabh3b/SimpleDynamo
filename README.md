# Programming Assignment 4: Simple Dynamo
...
* `././simpledynamo-grading.osx ~/..../app/build/outputs/apk/debug/app-debug.apk`



## Learning Outcomes
* Understanding of DynamoDB
* Working on multithreading and semaphores
* data replication & partitioning
* Node failure to provide availability and linearizability
